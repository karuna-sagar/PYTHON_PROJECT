...
MY_EMAIL = "sagarsinghrajput1221@gmail.com"
PASS = "jixtpcoizjurasqi"
today = (dt.datetime.now().month,dt.datetime.now().day)
# print(today)
#**********today is written as dt as module datetime as class now as function and  of today********
...
# ************  we can write data_row.month and data_row.day********************
...
if (today) in new_dict:
    ...
    with open(file_path) as letter_file:
        ...
        # print(content)
        k = content.replace("[NAME]",birthday_person["name"])
